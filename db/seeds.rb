...
Profile.create!([
  {user_id: 1, first_name: "Kaysser",
   owner: "Eddie Kayyali",
   city: "Miami", 
   state: "Floria", 
   weburl: "www.macparking.co", 
   last_name: "Kayyali", 
   name: "Mac Parking inc.", 
   email: "kaykayyali@macparking.co", 
   phone: "3053181328", 
   imageurl: "http://www.macparkinginc.com/images/bg_kirh.jpg", 
   rating: 5, 
   description: "The greatest valet company on the face of the planet"}
])
