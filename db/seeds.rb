User.create!([
  ...
  {role: "vendor", email: "john@doe.com", password: "password", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 3, current_sign_in_at: "2015-07-29 15:42:15", last_sign_in_at: "2015-07-29 15:23:13", current_sign_in_ip: "::1", last_sign_in_ip: "::1", first_name: "John", last_name: "Doe", name: nil, owner: nil, city: "Miami", state: "FL", rating: 4},
  {role: "vendor", email: "nizar@ironhack.com", password: "password", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 1, current_sign_in_at: "2015-07-29 19:25:42", last_sign_in_at: "2015-07-29 19:25:42", current_sign_in_ip: "::1", last_sign_in_ip: "::1", first_name: "Nizar's", last_name: "Khalife", name: "Flowers R Us", owner: "Nizar Khalife", city: "Miami", state: "FL", rating: 3}
])
