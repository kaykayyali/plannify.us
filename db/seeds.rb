User.create!([
  {role: "vendor", email: "gvale014@fiu.edu", password: "password", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 9, current_sign_in_at: "2015-07-29 22:24:34", last_sign_in_at: "2015-07-29 21:18:30", current_sign_in_ip: "::1", last_sign_in_ip: "::1", first_name: "Gloria ", last_name: "Valencia", name: "MAC Parking", owner: nil, city: nil, state: nil, rating: nil},
  ...
  {role: "organizer", email: "nizar@ironhack.com", password: "password", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 1, current_sign_in_at: "2015-07-29 19:25:42", last_sign_in_at: "2015-07-29 19:25:42", current_sign_in_ip: "::1", last_sign_in_ip: "::1", first_name: "Nizar's", last_name: "Khalife", name: "Flower R Us", owner: nil, city: nil, state: nil, rating: nil}
])
