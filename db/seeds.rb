...
AssociatedService.create!([
  {service_id: 4, user_id: 3}
])
ConfirmedService.create!([
  {event_id: 1, associated_service_id: 5}
])
Event.create!([
...
Profile.create!([
  ...
  {user_id: 3, first_name: nil, owner: "Gloria Valencia", city: "North Miami Beach", state: "FL", weburl: "www.flowers.com", last_name: nil, name: "Flower Power", email: "gvale014@fiu.edu", phone: "3054670704", imageurl: "", rating: nil, description: nil, message: "Flowers!", address: "1835 NE Miami Gardens Dr", zipcode: "33179", service_type: "4"}
])
Service.create!([
  {name: "Lighting"},
  {name: "Valet"},
